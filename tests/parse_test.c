...
static char *test_tracemask(void *context)
{
    ...
    qd_tracemask_add_router(tm, "amqp:/_topo/0/0/Router.A", 0);
    qd_tracemask_add_router(tm, "amqp:/_topo/0/0/Router.B", 1);
    qd_tracemask_add_router(tm, "amqp:/_topo/0/0/Router.C", 2);
    qd_tracemask_add_router(tm, "amqp:/_topo/0/0/Router.D", 3);
    qd_tracemask_add_router(tm, "amqp:/_topo/0/0/Router.E", 4);
    qd_tracemask_add_router(tm, "amqp:/_topo/0/0/Router.F", 5);
