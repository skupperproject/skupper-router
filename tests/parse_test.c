...
{
    "\xd0\x00\x00\x01\x1c\x00\x00\x00\x01"  // 1
    "\xd0\x00\x00\x01\x13\x00\x00\x00\x01"  // 2
    "\xd0\x00\x00\x01\x0a\x00\x00\x00\x01"  // 3
    "\xd0\x00\x00\x01\x01\x00\x00\x00\x01"  // 4
    "\xd0\x00\x00\x00\xf8\x00\x00\x00\x01"  // 5
    "\xd0\x00\x00\x00\xef\x00\x00\x00\x01"  // 6
    "\xd0\x00\x00\x00\xe6\x00\x00\x00\x01"  // 7
    "\xd0\x00\x00\x00\xdd\x00\x00\x00\x01"  // 8
    "\xd0\x00\x00\x00\xd4\x00\x00\x00\x01"  // 9
    "\xd0\x00\x00\x00\xcb\x00\x00\x00\x01"  // 10
    "\xd0\x00\x00\x00\xc2\x00\x00\x00\x01"  // 11
    "\xd0\x00\x00\x00\xb9\x00\x00\x00\x01"  // 12
    "\xd0\x00\x00\x00\xb0\x00\x00\x00\x01"  // 13
    "\xd0\x00\x00\x00\xa7\x00\x00\x00\x01"  // 14
    "\xd0\x00\x00\x00\x9e\x00\x00\x00\x01"  // 15
    "\xd0\x00\x00\x00\x95\x00\x00\x00\x01"  // 16
    "\xd0\x00\x00\x00\x8c\x00\x00\x00\x01"  // 17
    "\xd0\x00\x00\x00\x83\x00\x00\x00\x01"  // 18
    "\xd0\x00\x00\x00\x7a\x00\x00\x00\x01"  // 19
    "\xd0\x00\x00\x00\x71\x00\x00\x00\x01"  // 20
    "\xd0\x00\x00\x00\x68\x00\x00\x00\x01"  // 21
    "\xd0\x00\x00\x00\x5f\x00\x00\x00\x01"  // 22
    "\xd0\x00\x00\x00\x56\x00\x00\x00\x01"  // 23
    "\xd0\x00\x00\x00\x4d\x00\x00\x00\x01"  // 24
    "\xd0\x00\x00\x00\x44\x00\x00\x00\x01"  // 25
    "\xd0\x00\x00\x00\x3b\x00\x00\x00\x01"  // 26
    "\xd0\x00\x00\x00\x32\x00\x00\x00\x01"  // 27
    "\xd0\x00\x00\x00\x29\x00\x00\x00\x01"  // 28
    "\xd0\x00\x00\x00\x20\x00\x00\x00\x01"  // 29
    "\xd0\x00\x00\x00\x17\x00\x00\x00\x01"  // 30
    "\xd0\x00\x00\x00\x0e\x00\x00\x00\x01"  // 31
    "\xd0\x00\x00\x00\x05\x00\x00\x00\x01"  // 32
    "\x45",                                 // 33
    289,
    "Maximum field recursion exceeded"
},
{0, 0, 0}
};
...
static char *test_field_api(void *context)
{
    char *result = 0;
    qd_buffer_list_t blist = DEQ_EMPTY;
    qd_composed_field_t *comp = qd_compose_subfield(0);
    uint32_t uint_val = 0x123456;

    qd_compose_start_list(comp);   // LIST8
    qd_compose_insert_string(comp, "STR8-UTF8");
    qd_compose_insert_uint(comp, uint_val);
    qd_compose_insert_null(comp);
    qd_compose_end_list(comp);

    qd_compose_take_buffers(comp, &blist);
    qd_compose_free(comp);

    qd_iterator_t *iter = qd_iterator_buffer(DEQ_HEAD(blist), 0,
