...
class RouterConfigTest(TestCase):
    ...
    def setUpClass(cls):
        ...
        # httpConnector with invalid password
    ...
    def test_48_router_in_error(self):
        ...
        self.routers[27].wait_log_message(err, timeout=1.0)
