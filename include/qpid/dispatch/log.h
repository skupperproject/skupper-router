...
typedef enum {
    ...
    QD_LOG_NOTICE   =0x04, ///< Information messages useful to users
    QD_LOG_WARNING  =0x08, ///< Notice of important but non-error events.
    QD_LOG_ERROR    =0x10, ///< Warning of event that may be a problem.
    QD_LOG_CRITICAL =0x20, ///< Error, definitely a problem
} qd_log_level_t;
