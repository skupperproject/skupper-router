...
int qdrc_client_request_CT(qdrc_client_t                 *client,
                           ...
                           qdrc_client_request_done_CT_t  done_cb)
{
    qd_log(QD_LOG_MODULE_ROUTER_CORE, QD_LOG_TRACE, "New core client request created c=%p, rc=%p", (void *) client,
           request_context);
                                  ...
                                  qd_message_t *message)
{
    ...
    if (complete) {
        ...
        if (cid_iter) {
            ...
            qd_log(QD_LOG_MODULE_ROUTER_CORE, QD_LOG_ERROR, "Invalid core client reply message: no correlation-id");
