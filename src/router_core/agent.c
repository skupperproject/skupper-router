...
static void qdrh_query_get_first_CT(qdr_core_t *core, qdr_action_t *action, bool discard)
{
    ...
    if (!discard) {
        ...
        case QD_ROUTER_ROUTER_STATS:      qdra_router_stats_get_first_CT(core, query, offset); break;
...
static void qdrh_query_get_next_CT(qdr_core_t *core, qdr_action_t *action, bool discard)
{
    ...
    if (!discard) {
        ...
        case QD_ROUTER_ROUTER_STATS:      qdra_router_stats_get_next_CT(core, query); break;
