...
{
    qd_log(QD_LOG_MODULE_ADDRESS_WATCH, QD_LOG_INFO,
...
{
    qd_log(QD_LOG_MODULE_ADDRESS_WATCH, QD_LOG_INFO, "Start Watch: %s", address);
...
{
    qd_log(QD_LOG_MODULE_ADDRESS_WATCH, QD_LOG_INFO, "Stop Watch: %s", address);
